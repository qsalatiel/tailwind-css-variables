...
I created a [function](https://github.com/qsalatiel/tailwind-css-variables/blob/main/utils.js) to reduce the manual job of creating a theme color for each CSS variable.
